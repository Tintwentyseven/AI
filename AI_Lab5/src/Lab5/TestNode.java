...
public class TestNode {
	...
	public static void main(String[] args) {
		Puzzle p = new Puzzle();
		p.readInput("D:\\workspace\\AI_Lab5\\src\\txt\\PuzzleMap.txt", "D:\\workspace\\AI_Lab5\\src\\txt\\PuzzleGoalState.txt");
...
System.out.println("------------------------");
		p.getInitialState().setH(p.computeH2(p.getInitialState()));
		Node res1 = new AStartSearch().execute(p);
		System.out.println("AStart Search");
